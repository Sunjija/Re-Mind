...
- 이해 확인 화면은 사용자의 원문에서 고른 장면·의미·감정을 선으로 구분된 한 장의 기록처럼 보여준다. 사용자는 가까움·다름·모르겠음을 선택하며, 다르면 자신의 표현으로 최대 두 번 다시 확인할 수 있다.
- 심화 단계는 기본 경로가 아니다. ‘한 질문 더’와 ‘지금 정리’를 같은 위계로 제시하고, 심화 질문은 한 개만 허용한다.
