...
9. 사건이 나에게 닿은 의미 구분
10. AI가 사용자의 원문에서 고른 이해를 가까움·다름·모르겠음으로 확인
11. 다르면 사용자의 표현으로 최대 두 번 다시 확인
12. 지키고 싶었던 가치·필요 선택
13. 한 질문 더 이어갈지 지금 정리할지 선택
14. 원할 때만 목표에 맞는 심화 질문 한 개
15. 사용자의 말만으로 만든 마음 지도 확인·수정
16. 다음 행동을 사용자가 직접 선택
17. 세션 후 명료도 및 익명형 피드백
18. 개인 원문을 제외한 테스트 결과 복사

진행 숫자는 장면 중복 생략, 조건부 멈춤, 선택형 심화 질문 포함 여부에 따라 달라진다. 현재 일반 경로는 14단계, 심화 경로는 15단계로 표시된다.
